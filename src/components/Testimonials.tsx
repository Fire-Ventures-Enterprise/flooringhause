...
const testimonials = [
  {
    ...
    location: "Toronto, ON",
    rating: 5,
    text: "FlooringHause transformed our entire home with beautiful hardwood floors. The quality is exceptional and the installation team was professional and efficient.",
  ...
  },
  {
    ...
    rating: 5,
    text: "The quality of the natural stone flooring is incredible. FlooringHause made the entire process seamless and stress-free.",
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Join thousands of satisfied homeowners who transformed their spaces with FlooringHause
          </p>
        </div>
